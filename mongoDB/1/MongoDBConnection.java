...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "eduardopessoal81_db_user";
    private static final String PASSWORD = "PVvdx5IenuxFUd7C";
    private static final String CLUSTER_URL = "cluster0.vptvthm.mongodb.net"; // Substitua pelo seu cluster se for diferente
    ...
    public static void main(String[] args) {
        ...
        UsuarioOperations operations = new UsuarioOperations(connection.getDatabase());
        ...
        // 3) Alterar idade de Bob para 32
